...
float     Tensao_fonte          = 0.0,
          ...
          Tensao_ref_maxima     = 200.0,
          Tensao_ref_minima     = 50.0;
...
void setup()
{
  ...
  TCNT2  = 243;           //inicia Timer2 para contar a partir de 131 e estabelecer uma frequencia de 250Hz
